...
class SaveReminderFragment : BaseFragment() {
    ...
    private val REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION_RESULT_CODE = 100
    private val REQUEST_FOREGROUND_ONLY_PERMISSIONS_REQUEST_CODE = 101
    private val REQUEST_TURN_DEVICE_LOCATION_ON = 102
...
//             2) save the reminder to the local db
    ...
    private fun addGeofences(reminderDataItem: ReminderDataItem) {
        ...
        geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent)?.run {
            ...
            addOnFailureListener {
                ...
                Toast.makeText(context, R.string.geofences_not_added, Toast.LENGTH_SHORT)
                        .show()
            }
        }
    }
    ...
    companion object {
        internal val TAG = SaveReminderFragment::class.java.simpleName
